...
", Based on the Job Position, Job Description & Years of Experience, generate a total of 5 questions: 4 Interview questions and 1 real-world HR problem-solving question. Provide answers for each question in JSON format. The JSON should contain a single array with all 5 questions and their respective answers. Do not include any additional fields such as question type.";
